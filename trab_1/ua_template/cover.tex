...
\section{Malha de Elementos Finitos e Condições de Fronteira}
...
\subsection{Configuração da Análise Modal no NX Nastran}
...
\section{Configuração A --- Nervuras a 25° com o Plano de Simetria}

\subsection{Descrição Geométrica}
...
\subsection{Justificação Estrutural}
...
\section{Configuração B --- Nervuras Paralelas ao Plano de Simetria}
